    ...
    <div class="container mx-auto p-6 max-w-4xl">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-start">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Buat User Account Guru</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Buat akun login untuk guru {{ $guru->nama_lengkap }}
                    </p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <form action="{{ route('guru.store-user', $guru) }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            value="{{ old('email') }}" placeholder="masukkan.email@sekolah.id" required>
                        @error('email')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Email ini akan digunakan untuk login ke
                            sistem</p>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-blue-800 dark:text-blue-300">
                                <strong>Informasi:</strong> User akan dibuat dengan role <strong>Guru</strong> dan dapat
                                mengakses dashboard guru, mengelola absensi, dan fitur lainnya yang tersedia untuk guru.
                            </p>
                        </div>
                    </div>
                </div>
