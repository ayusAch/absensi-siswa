    ...
    <div class="container mx-auto p-6 max-w-2xl">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-2">Perbarui data {{ $guru->nama_lengkap }}</p>
            </div>
            ...
            <form action="{{ route('guru.update', $guru->id) }}" method="POST">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">{{ old('alamat', $guru->alamat) }}</textarea>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="2"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">{{ old('keterangan', $guru->keterangan) }}</textarea>
                </div>
